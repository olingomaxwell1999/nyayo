...
import { MdBusinessCenter, MdChair, MdPool } from "react-icons/md";
import {
  FaCouch,
  FaParking,
  FaSatelliteDish,
    ...
    <div data-aos="fade-up" className="city">
      ...
      <div id="amenities" className="bottom-city">
        ...
        <div className="city-card">
          ...
          <h3>Designated vehicular drop-off areas</h3>
        </div>
        ...
        <div className="city-card">
          ...
          <h3>Secure Parking for Residents and Visitors</h3>
        </div>

        <div className="city-card">
          <GiCctvCamera className="icon-city" color={"#777777"} />
          <h3>Secure Plot Boundary and CCTV Surveillance </h3>
        </div>

        <div className="city-card">
          <FaSatelliteDish className="icon-city" color={"#777777"} />
          <h3>Satellite TV and Internet Connectivity Provisions</h3>
        </div>
        ...
        {/* <div className="city-card">
          <MdPool className="icon-city" color={"#777777"} />
          <h3>Rooftop Swimming Pool</h3>
        </div> */}
      </div>
    </div>
