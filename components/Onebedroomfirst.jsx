  ...
  return (
    <div className="amenities-second pos">
      ...
      <div className="amenities-first-text">
        ...
        <p>
          Our <strong>42sqm & 37sqm</strong> one-bedroom apartments provide
          spacious, well-lit living areas, promising a contemporary and elegant
          residential experience. Investors can anticipate excellent returns
          from this highly coveted property.
        </p>
      </div>
